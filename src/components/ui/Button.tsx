...
const baseStyles =
  "inline-flex items-center justify-center gap-2 rounded px-5 py-2.5 min-h-[44px] min-w-[44px] text-[14px] font-medium transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2 active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none disabled:cursor-not-allowed";
